...
public class Variables : MonoBehaviour {
    ...
    */
    ...
    void Start() {
		...
		//DESDE AQUI ES LO QUE VIMOS EN CLASE
		//Forma para declarar variables commpuestas:

        Color otroColor = new Color(0.5f, 0.3f, 0.1f); //los valores de Color siempre deben estar entre 0 y 1
		Color magenta = new Color (0.5f, 0.9f, 0.4f, 0.5f); 
		Vector3 poscionPersonaje = new Vector3 (6.77765544684f, -52.44511346f);
		//Atajos: Las siguientes dos lineas hacen lo mismo:
		//Vector3 arriba = new Vector3 (0.0f, 1.0f, 0.0f);
